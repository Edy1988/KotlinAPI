...
the maximum temperature is 25 degrees
```
```
...
```
```
If the temperature outise is below 18 degrees, 
increase the temperature to 21
```
```
If the temperature is above 18, 
temerature is at default
```